...
"""
Settings (common/shared between all deployments)
"""

# Settings differ bewteen deployments (e.g., local dev, remote dev, production).
# The settings in this file are common (shared) between all deployments and are 
# loaded by each deployment-specific settings file. 

# The deployment-specific files include DEBUG, ALLOWED_HOSTS, SECRET_KEY, STATIC_ROOT, 
# and DATABASES.

from pathlib import Path

# All paths specified in the project are relative to BASE_DIR.
# Set BASE_DIR to the parent (.../cedar_root/) folder, relative to this file.
...
# unless otherwise noted. Non-default middleware are noted in comments.

MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',

    # Use Whitenoise (not default).
...
# or CSS. Django refers to these files as “static files”. Django provides 
...
# Set additional directories to search for static files. Currently set to the
# default directory specified by STATIC_URL.
STATICFILES_DIRS = [
