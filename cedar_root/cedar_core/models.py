...
class reference(models.Model): # ====================================================================================================================
    ...
    study_design_detail            = models.TextField(blank      = True,  
                                                      help_text  = dict_help['study_design_detail'])

    study_sample_method            = models.TextField(blank      = True,  
                                                      help_text  = dict_help['study_sample_method'])
    ...
    ref_has_ast_explicit_break     = models.CharField(null       = True, 
                                                      ...
                                                      help_text  = dict_help['ref_has_ast_explicit_break'])

    ref_has_ast_mic_table          = models.CharField(null       = True, 
                                                      blank      = True, 
                                                      max_length = 2, 
                                                      choices    = ANSWER_CHOICES, 
                                                      help_text  = dict_help['ref_has_ast_mic_table'])

    ref_has_data_pheno_level       = models.CharField(null       = True, 
                                                      blank      = True, 
                                                      max_length = 2, 
                                                      choices    = ANSWER_CHOICES, 
                                                      help_text  = dict_help['ref_has_data_pheno_level'])

    ref_has_data_geno_level        = models.CharField(null       = True, 
                                                      blank      = True, 
                                                      max_length = 2, 
                                                      choices    = ANSWER_CHOICES, 
                                                      help_text  = dict_help['ref_has_data_geno_level'])

    ref_has_esbl_factor            = models.CharField(null       = True, 
                                                      blank      = True, 
                                                      max_length = 2, 
                                                      choices    = ANSWER_CHOICES,
                                                      help_text  = dict_help['ref_has_esbl_factor'])
...
class ast_breakpoint_version(models.Model): # =========================================================================
    ...
    ast_breakpoint_std         = models.CharField(max_length=200, blank=True, null=True, help_text=dict_help['ast_breakpoint_std']) # TODO: TO FK
