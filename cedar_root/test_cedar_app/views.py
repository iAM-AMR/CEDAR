...
def view_references(request):
    ...
    """if request.method == 'POST':
        ...
        return render(request, 'test_cedar_app/view_refs_new.html', context)
    """
...
def view_factors(request, ref_id):
    ...
    return render(request, 'test_cedar_app/view_factors.html', context)
...
def export_query(request):
    ...
    if request.method == 'POST':
        ...
        if query_form.is_valid():
            ...
            if len(export_facs) == 0:
                ...
                return render(request, 'test_cedar_app/export_query.html', {'query_form': QuerySelectForm(), 'message_text': 'No factors exist that meet the chosen criteria. Please try broadening your query'})
    ...
    return render(request, 'test_cedar_app/export_query.html', context)
...
def delete_factor(request, ref_id, fac_id):
    ...
    return redirect('/test_cedar_app/references/' + str(ref_id) + '/factors/')
    #return render(request,'test_cedar_app/view_factors.html', context)
...
def add_ref_info(request, ref_id, form_type):
    ...
    if form_type == 'loc':
        ...
        redir_path = '/test_cedar_app/references/' + str(ref_id) + '/#loc-md'
    else:
        new_obj = reference_note(loc_ref_id = ref)
        redir_path = '/test_cedar_app/references/' + str(ref_id) + '/#notes-md'
...
def factor_detail(request, ref_id, fac_id):
    ...
    return render(request, 'test_cedar_app/factor_detail_new.html', context)
    

def add_ref_success(request):
    return HttpResponse('The reference was updated successfully.')
