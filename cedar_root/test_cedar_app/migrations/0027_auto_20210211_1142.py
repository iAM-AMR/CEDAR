...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('test_cedar_app', '0026_auto_20210211_1039'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='factor',
            name='host_01_id',
            field=models.ForeignKey(blank=True, help_text='The ID of the parent host', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.host_01'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='microbe_01_id',
            field=models.ForeignKey(blank=True, help_text='The ID of the parent microbe', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.microbe_01'),
        ),
        migrations.AlterField(
            model_name='factor',
