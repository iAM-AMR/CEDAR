...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('test_cedar_app', '0007_auto_20201216_1203'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='factor',
            name='host_01',
            field=models.ForeignKey(blank=True, help_text='The host animal from which the microbe was isolated', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.host_01'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='host_02',
            field=models.ForeignKey(blank=True, help_text='The host subtype from which the microbe was isolated', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.host_02'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='microbe_01',
            field=models.ForeignKey(blank=True, help_text='The microbe assayed for resistance', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.microbe_01'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='microbe_02',
            field=models.ForeignKey(blank=True, help_text='The subtype of the microbe assayed for resistance', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.microbe_02'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='moa_type',
            field=models.ForeignKey(blank=True, help_text='The type of measure of association reported for the factor', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.moa_type'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='moa_unit',
            field=models.ForeignKey(blank=True, help_text='The experimental unit or level of analysis for which the measure of association is presented', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.moa_unit'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='odds_ratio_lo',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, help_text='The production stage at which the groups were allocated (i.e. factor applied)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='factors_a', to='test_cedar_app.production_stage'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='prod_stage_group_observe',
            field=models.ForeignKey(blank=True, help_text='The production stage at which the observations were recorded (i.e. factor observed)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='factors_o', to='test_cedar_app.production_stage'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='resistance',
            field=models.ForeignKey(blank=True, help_text='The antimicrobial for which resistance was assayed.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='factors_resistance', to='test_cedar_app.atc_vet'),
        ),
    ]
