...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('test_cedar_app', '0011_auto_20210204_1539'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='factor',
            name='amu_id',
            field=models.ManyToManyField(db_table='factor_amu_join', help_text='The antimicrobials(s) that were administered to one or more groups within the study population', related_name='factors_amu', to='test_cedar_app.atc_vet'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='contable_a',
        ...
        migrations.AlterField(
            model_name='factor',
            name='factor_ref',
            field=models.ForeignKey(help_text='The reference that describes the factor', on_delete=django.db.models.deletion.CASCADE, to='test_cedar_app.reference', to_field='other_reference_id'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='factor_title',
        ...
        migrations.AlterField(
            model_name='factor',
            name='resistance',
            field=models.ForeignKey(blank=True, help_text='The resistance that was assayed', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='factors_resistance', to='test_cedar_app.atc_vet'),
        ),
        migrations.AlterField(
            model_name='factor',
            name='table_n_exp',
        ...
        migrations.AlterField(
            model_name='factor_exclusion',
            name='factor',
            field=models.ForeignKey(blank=True, help_text='The factor that is to be excluded', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.factor'),
        ),
        migrations.AlterField(
            model_name='factor_exclusion',
            name='model',
            field=models.ForeignKey(blank=True, help_text='The model from which the factor should be excluded', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.model'),
        ),
        migrations.AlterField(
            model_name='host_01',
            name='host_name',
        ...
        migrations.AlterField(
            ...
            name='loc_ref',
            field=models.ForeignKey(blank=True, help_text='The reference pertaining to this location', null=True, on_delete=django.db.models.deletion.CASCADE, to='test_cedar_app.reference', to_field='other_reference_id'),
        ),
        migrations.AlterField(
            model_name='moa_type',
            name='res_format',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, help_text='The user who created the model/query', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users_c', to='test_cedar_app.legacy_user'),
        ),
        migrations.AlterField(
            model_name='model',
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(db_table='model_user_join', help_text='The user who maintains the model/query', to='test_cedar_app.legacy_user'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='reference',
            name='study_design',
            field=models.ForeignKey(blank=True, help_text='The type of study design used in the study', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.study_design'),
        ),
        migrations.AlterField(
            model_name='reference',
        ...
        migrations.AlterField(
            ...
            name='note_ref',
            field=models.ForeignKey(blank=True, help_text='The reference pertaining to this note', null=True, on_delete=django.db.models.deletion.CASCADE, to='test_cedar_app.reference', to_field='other_reference_id'),
        ),
        migrations.AlterField(
            model_name='reference_note',
            name='user',
            field=models.ForeignKey(blank=True, help_text='The user who made the note', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.legacy_user'),
        ),
        migrations.AlterField(
