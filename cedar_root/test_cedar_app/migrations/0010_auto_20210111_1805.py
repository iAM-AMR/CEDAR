...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('test_cedar_app', '0009_auto_20210111_1053'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='reference',
            name='publisher',
            field=models.ForeignKey(blank=True, help_text='The outlet which published the study', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.publisher'),
        ),
        migrations.AlterField(
            model_name='reference',
            name='study_design',
            field=models.ForeignKey(blank=True, help_text='The type of study design applied', null=True, on_delete=django.db.models.deletion.SET_NULL, to='test_cedar_app.study_design'),
        ),
        migrations.AlterField(
            model_name='reference',
